        ...
        <li className="list-group-item">
            <div className="row w-100">
                <div className="col-12 col-sm-6 col-md-3 px-0">
                    <img src="https://banner2.cleanpng.com/20190926/vfq/transparent-standing-silhouette-male-joint-human-1713871503511.webp" className="rounded-circle mx-auto d-block img-fluid" />
                </div>
